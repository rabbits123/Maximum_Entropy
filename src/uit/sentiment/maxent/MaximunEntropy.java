...
public class MaximunEntropy implements Serializable {
...
////  VietnameseMaxentTagger vtagger = new VietnameseMaxentTagger();
    ...
    public MaximunEntropy() {
        ...
        try {
            ...
            Logger.getLogger(MaximunEntropy.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        }//end
    ...
    public static void main(String[] args) {
        MaximunEntropy ma = new MaximunEntropy();
        ReadTextFile reader = new ReadTextFile();
        
        List<String> trainingSentences = new ArrayList<>();
        trainingSentences = ReadTextFile.readTextFile("src/resources/data/corpus_full.txt");
       
        ma.trainingData2(trainingSentences);
        
        System.out.println(ma.predictSentence("có nhiều bài_tập về nhà"));
...
//        trainingSentences = reader.readTextFile(0, 1000, "src/resources/data/corpus_full.txt");
//        ma.trainingData2(trainingSentences);
//        
//        System.out.println(ma.predictSentence("cô rất nhiệt_tình và gần_gũi với sinh_viên"));
